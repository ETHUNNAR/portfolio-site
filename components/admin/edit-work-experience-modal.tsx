...
export function EditWorkExperienceModal({ id, onClose, onSave }: EditWorkExperienceModalProps) {
      ...
      >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-xl font-display font-bold text-white">Edit Work Experience</h3>
            <button
              onClick={onClose}
                ...
                <div className="border-t border-neutral-800 pt-4 mt-4">
                  ...
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      onChange={(e) => setFormData({ ...formData, position_da: e.target.value })}
                      className="w-full bg-surface border border-neutral-700 rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-accent"
